...
{
	public const short ucMsg = 888;
	public const short vcMsg = 889;

	public enum NetworkMasterServerEvent
	{
		MessageSent // Registration failed because an empty game name was given.
	}

	public class UCMsg : MessageBase
	{
